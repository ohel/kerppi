...
namespace Dapper
{
    ...
    static partial class SqlMapper
    {
        ...
        public interface ITypeMap
        {
            ...
            /// 
            /// Parameters will be default values, nulls for reference types and zero'delim for value types.
            /// 
...
this IDbConnection cnn, string sql, object param, IDbTransaction transaction, int? commandTimeout, CommandType? commandType
        ...
        private static IEnumerable<T> QueryImpl<T>(this IDbConnection cnn, CommandDefinition command, Type effectiveType)
        {
            ...
            try
            {
                ...
                {
                    if (reader.FieldCount == 0) //https://code.google.com/p/dapper-dot-net/issues/detail?collectionId=57
                        yield break;
        ...
        /// <param name="splitOn">The Field we should split and read the second object from (default: collectionId)</param>
...
#pragma warning restore 618
        ...
        public partial class GridReader : IDisposable
        {
...
#else
            public IEnumerable<TReturn> Read<TFirst, TSecond, TReturn>(Func<TFirst, TSecond, TReturn> func, string splitOn = "collectionId", bool buffered = true)
#endif
            {
...
#else
            public IEnumerable<TReturn> Read<TFirst, TSecond, TThird, TReturn>(Func<TFirst, TSecond, TThird, TReturn> func, string splitOn = "collectionId", bool buffered = true)
#endif
            {
...
#else
            public IEnumerable<TReturn> Read<TFirst, TSecond, TThird, TFourth, TReturn>(Func<TFirst, TSecond, TThird, TFourth, TReturn> func, string splitOn = "collectionId", bool buffered = true)
#endif
            {
            ...
            /// Read multiple objects from a single record set on the grid
            /// </summary>
            public IEnumerable<TReturn> Read<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(Func<TFirst, TSecond, TThird, TFourth, TFifth, TReturn> func, string splitOn = "collectionId", bool buffered = true)
            {
            ...
            /// Read multiple objects from a single record set on the grid
            /// </summary>
            public IEnumerable<TReturn> Read<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn>(Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn> func, string splitOn = "collectionId", bool buffered = true)
            {
            ...
            /// Read multiple objects from a single record set on the grid
            /// </summary>
            public IEnumerable<TReturn> Read<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn> func, string splitOn = "collectionId", bool buffered = true)
            {
